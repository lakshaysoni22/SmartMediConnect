    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center p-4 overflow-hidden bg-slate-50 dark:bg-[#0f172a]">
      ...
      <div className="relative z-10 w-full max-w-[420px] flex flex-col gap-6 rounded-2xl border border-white/60 bg-white/70 p-8 shadow-2xl backdrop-blur-xl dark:bg-[#1e293b]/70 dark:border-white/10 sm:p-10 transition-all duration-300">
        ...
        <div className="flex flex-col items-center gap-4 text-center mt-6 sm:mt-4">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-50 to-cyan-100 shadow-sm ring-1 ring-teal-200 dark:from-teal-900/30 dark:to-cyan-800/30 dark:ring-teal-800/50">
            <span className="material-symbols-outlined text-teal-600 dark:text-teal-400" style={{ fontSize: '32px' }}>
        ...
        <div className="bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 border border-teal-200 dark:border-teal-800 rounded-xl p-4">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-teal-100 dark:bg-teal-900/40 flex items-center justify-center">
              <span className="material-symbols-outlined text-teal-600 dark:text-teal-400 text-[18px]">info</span>
            </div>
            <div className="flex-1">
              <h3 className="text-sm font-bold text-teal-900 dark:text-teal-300 mb-1">Login Instructions</h3>
              <ul className="text-xs text-teal-800 dark:text-teal-400 space-y-1">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-teal-500 mt-0.5">•</span>
                  <span><strong>Password:</strong> Use only <code className="px-1.5 py-0.5 bg-teal-100 dark:bg-teal-900/40 rounded font-mono font-bold">123456789</code></span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <form className="flex flex-col gap-5 mt-2" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="group relative flex items-center">
              <div className="absolute left-3.5 flex items-center pointer-events-none">
                <span
                  className="material-symbols-outlined text-slate-400 group-focus-within:text-teal-600 transition-colors"
                  style={{ fontSize: '20px' }}
                >
                  badge
                </span>
              ...
              <input
                ...
                className="h-11 w-full rounded-lg border border-slate-200 bg-white/50 pl-10 pr-4 text-sm font-medium text-slate-900 placeholder-slate-400 outline-none transition-all focus:border-teal-500 focus:bg-white focus:ring-2 focus:ring-teal-500/10 dark:border-slate-700 dark:bg-slate-900/50 dark:text-white dark:focus:bg-slate-900"
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              ...
              <a
                href="#"
                className="text-xs font-semibold text-teal-600 hover:text-teal-700 hover:underline dark:text-teal-400"
              >
                Forgot Password?
              </a>
            </div>
          ...
          <button
            type="submit"
            className="mt-2 flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-teal-600 text-white shadow-lg shadow-teal-500/20 transition-all hover:bg-teal-700 hover:shadow-teal-600/30 focus:ring-2 focus:ring-teal-600 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
          >
        ...
        <div className="flex flex-col items-center gap-5">
          ...
          >
            ...
            <span className="text-teal-600 dark:text-teal-400 font-semibold group-hover:underline decoration-teal-600/50 underline-offset-4">
              Switch Portal
            </span>
          </button>
